...
Widget _labelCreateAccount(BuildContext ctx) => GestureDetector(
      onTap: () {
        NavigationHelper.createAccount(ctx);
      },
      child: Text(
        'Create Account',
        style: TextStyle(
...
Widget forgotPasswordFooter(BuildContext ctx) => Container(

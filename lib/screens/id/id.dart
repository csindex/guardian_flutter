...
class _IDState extends State<ID> {
  ...
  Widget build(BuildContext context) {
    return (widget.userProfileVM == null
        || widget.userProfileVM.profilePic == null
        || widget.userProfileVM.profilePic.contains('null')) ? FutureBuilder<File>(
                ...
                child: Container(
                  ...
                  child: CircleAvatar(
                    ...
                    child: CircleAvatar(
                      radius: 98.0,
                      backgroundColor: Colors.white,
                      backgroundImage: NetworkImage(widget.userProfileVM.profilePic),
                    ),
                  ),
                ),
              ),

...
final String secretHollowsEndPoint = 'http://dev.guardian.ph';
final String secretHollowsEndPoint5 = 'http://dev.guardian.ph:5000';//'https://ce26c1b1-bc28-4a2e-b2cb-c1460f1e904f.mock.pstmn.io' //https://secret-hollows-28950.herokuapp.com
...
Widget vSpacer(double h) => SizedBox(height: h ?? 0.0,);

Widget hSpacer(double w) => SizedBox(width: w ?? 0.0,);

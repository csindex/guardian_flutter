...
class SendOtpDialog2 extends StatefulWidget {
  @override
  _SendOtpState2 createState() => _SendOtpState2();
}

class _SendOtpState2 extends State<SendOtpDialog2> {
  bool isLoading;
  // _SendOtpState(this.isLoading);
